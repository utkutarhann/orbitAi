...
const RESTAURANTS = [
  ...
  },
  {
    ...
    "distanceKm": 1.2,
    "priceLevel": 2,
    "tags": ["pizza", "italyan", "salata", "vejetaryen-secenekli"],
    "menu": [
      {
        "id": "m56",
        "name": "Milano Pepperoni & Mozzarella Pizza",
        "image": "https://images.unsplash.com/photo-1534308983496-4fabb1a015ee?w=500&auto=format&fit=crop&q=80",
        "price": 380,
        "ingredients": ["mozzarella", "pepperoni", "domates sosu", "kekik"],
        "allergens": ["gluten", "süt ürünleri"],
        "calories": 780,
        "prepMinutes": 10,
        "tags": ["pizza", "italyan", "doyurucu"]
      },
      {
        "id": "m57",
        ...
        "image": "https://images.unsplash.com/photo-1540420773420-3366772f4999?w=500&auto=format&fit=crop&q=80",
        "price": 280,
        "ingredients": ["marul", "ton balığı", "salatalık", "domates", "siyah zeytin"],
